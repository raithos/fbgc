...
exportObj.SquadBuilder = (function() {
  ...
  SquadBuilder.prototype.onGameTypeChanged = function(gametype, cb) {
    ...
    this.desired_points_input.val(25);
  ...
  SquadBuilder.prototype.loadFromSerialized = function(serialized) {
    ...
    if (matches != null) {
      ...
      _ref2 = version > 7 ? ((_ref = matches[2].split('Z'), g = _ref[0], p = _ref[1], s = _ref[2], _ref), [g, parseInt(p), s]) : ((_ref1 = matches[2].split('!'), game_type_and_point_abbrev = _ref1[0], s = _ref1[1], _ref1), parseInt(game_type_and_point_abbrev.split('=')[1]) ? p = parseInt(game_type_and_point_abbrev.split('=')[1]) : p = 25, g = game_type_and_point_abbrev.split('=')[0], [g, p, s]), game_type_abbrev = _ref2[0], desired_points = _ref2[1], serialized_ships = _ref2[2];
      if (version < 9) {
  ...
  SquadBuilder.prototype.loadFromXWS = function(xws, cb) {
    ...
    switch (false) {
      case !(version_list > [0, 1]):
        ...
        serialized_squad_intro = "v9Z" + gamemode + "Z25Z";
